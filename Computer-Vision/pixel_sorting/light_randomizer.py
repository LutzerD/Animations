...
for r in dilation3:
        ...
        for i in start_indices:
                sample_arr =  dialationSample[row_index,i-int(minimum*(m.sin(row_index/50)+minimum/2)):stop_indices[pair_index]+int(minimum*(m.sin(row_index/50)+minimum/2))]
                #print(sample_arr)

                nr.shuffle(sample_arr)
                dialationSample[row_index,i-int(minimum*(m.sin(row_index/50)+minimum/2)):stop_indices[pair_index]+int(minimum*(m.sin(row_index/50)+minimum/2))] = sample_arr
